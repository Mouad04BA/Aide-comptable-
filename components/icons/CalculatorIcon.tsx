...
const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-18 0V5.625c0-1.036.84-1.875 1.875-1.875h14.25c1.035 0 1.875.84 1.875 1.875v10.875m-18 0h18" />
  </svg>
);
